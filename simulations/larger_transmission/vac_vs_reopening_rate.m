...
ylimits = [470, 870];
clevels = [550, 650, 700, 800];
cb_ticks = [470, 570, 670, 770, 870];
cb_tick_labels = {'470', '570', '670', '770', '870'};
...
ylimits = [1e5, 1.25e5];
clevels = [1.13e5, 1.15e5, 1.18e5];
cb_ticks = [1e5, 1.1e5, 1.2e5, 1.25e5];
cb_tick_labels = {'1e5', '1.1e5', '1.2e5', '1.25e5'};
...
ylimits = [5.1e4, 5.5e4];
clevels = [5.2e4, 5.3e4, 5.4e4];
cb_ticks = [5.1e4, 5.2e4, 5.3e4, 5.4e4, 5.5e4];
cb_tick_labels = {'5.1e4', '5.2e4', '5.3e4', '5.4e4', '5.5e4'};
...
ylimits = [5.5e4, 6.7e4];
clevels = [5.8e4, 6e4, 6.5e4];
cb_ticks = [5.5e4, 5.7e4, 6e4, 6.7e4];
cb_tick_labels = {'5.5e4', '5.7e4', '6e4', '6.7e4'};
