...
/// @lambdas - vector of lambda vectors for each location to add
/// @mult - <i, multiplication factors> - lambda vector i will be multiplied by the multiplication factor 
